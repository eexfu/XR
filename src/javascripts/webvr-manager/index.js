 ...
 */
class WebXRManager extends Emitter {
  constructor(renderer, effect, params) {
    super();
  ...
  setVRCompatibleOverride(isVRCompatible) {
  ...
  setVRCallback(callback) {
    this.vrCallback = callback;
  }

  setExitFullscreenCallback(callback) {
